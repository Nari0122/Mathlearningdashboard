                    ...
                    <DialogContent>
                        ...
                        <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-4 items-center gap-4">
                                <Label htmlFor="type" className="text-right">시험 구분</Label>
                                <Input
                                    id="type"
                                    value={examType}
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <Input id="score" type="number" value={score} onChange={(e) => setScore(e.target.value)} className="col-span-3" placeholder="점수 입력" />
                            </div>
                            <div className="grid grid-cols-4 items-center gap-4">
                ...
                <table className="w-full text-left text-sm">
                    <thead className="bg-gray-50 border-b">
                        <tr>
                            ...
                            <th className="p-4 font-medium text-gray-500">과목</th>
