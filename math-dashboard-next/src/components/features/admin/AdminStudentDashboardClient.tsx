...
export default function AdminStudentDashboardClient({
    stats,
    recentAssignments = [],
    recentRecords = [],
    recentReviewProblems = [],
    studentDocId,
}: AdminStudentDashboardClientProps) {
    return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        ...
                        <Link href={`/admin/students/${studentDocId}/review-submission`} className="text-xs text-muted-foreground flex items-center hover:text-emerald-600">
                            상세보기 <ChevronRight className="h-3 w-3" />
                        </Link>
                    </CardHeader>
                    <CardContent>
