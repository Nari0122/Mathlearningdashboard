import { X, Mail, Phone, User, Save, Lock, Check, AlertCircle } from 'lucide-react';
...
export function SupportModal({ isOpen, onClose }: SupportModalProps) {
  const { user, updateCurrentUserPassword } = useAuth();
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="px-4 py-2 bg-gray-50 rounded-lg border border-gray-200">
                <span className="text-gray-900 font-mono">{user.loginId}</span>
              </div>
